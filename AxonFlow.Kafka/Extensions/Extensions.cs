...
namespace AxonFlow
{
  ...
  {
    /// <summary>
    /// Adds the AxonFlow.Router Kafka Message Dispatcher to the service collection.
    /// </summary>
    /// <param name="services">The service collection.</param>
    /// <param name="config">The configuration action to configure the MessageDispatcherOptions.</param>
    /// <returns>The service collection with the AxonFlow.Router Kafka Message Dispatcher added.</returns>
