...
/// </param>
public record NotificationHandlerExecutor(object HandlerInstance, Func<Hikyaku.INotification, CancellationToken, Task> HandlerCallback): 
  Hikyaku.NotificationHandlerExecutor(HandlerInstance, HandlerCallback);